...
class Product(db.Model):
    ...
    cust = db.Column(db.Numeric(precision=8, scale=2), nullable=True)
    tax = db.Column(db.Numeric(precision=8, scale=2), nullable=True)
    ...
    datePurchase = db.Column(db.Date, nullable=True)
